    ...
    if(botaoSimplifica != undefined){
        ...
        console.log( fora + '√' + dentro)
            ...
            if(novoA < 0){
                ...
                x1 =
                <span class="fracao">
                    <span class="span1">${(novoB)} ${(nFora < 0 ? novoFora : "+" + novoFora)}√${dentro}</span>
                    <span>${novoA}</span>
                </span>
                `
                ...
                <span class="fracao">
                    <span class="span1">
                        ${(novoB)} ${(nForaMenos < 0 ? novoForaMenos : "+" + novoForaMenos)}√${dentro}
                    </span>
                    <span>${novoA}</span>
                </span>
                `
                ...
                x1 =
                <span class="fracao">
                    <span class="span1">${(novoB)} +${(novoFora == 1 ? "" : novoFora)}√${dentro}</span>
                    <span>${novoA}</span>
                </span>
                `
                ...
                <span class="fracao">
                    <span class="span1">
                        ${(novoB)} ${(novoForaMenos == -1 ? "-" : novoForaMenos)}√${dentro}
                    </span>
                    <span>${novoA}</span>
                </span>
                `
